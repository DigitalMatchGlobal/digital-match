    ...
    es: {
        ...
        'contact.when.note': 'Lo confirmamos en el chat, en el momento.',
        'contact.day.this': 'Esta semana',
        'contact.day.next': 'La próxima',
        'contact.day.any': 'Me adapto',
        'contact.time.morning': 'Mañana (9-12)',
        'contact.time.midday': 'Mediodía (12-15)',
        'contact.time.afternoon': 'Tarde (15-18)',
    ...
    en: {
        ...
        'contact.when.note': 'We confirm right there in the chat.',
        'contact.day.this': 'This week',
        'contact.day.next': 'Next week',
        'contact.day.any': "I'm flexible",
        'contact.time.morning': 'Morning (9-12)',
        'contact.time.midday': 'Midday (12-3)',
        'contact.time.afternoon': 'Afternoon (3-6)',
