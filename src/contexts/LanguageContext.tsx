    ...
    es: {
        ...
        'portfolio.home.title': 'Casos que respaldan lo que hacemos',
        'portfolio.home.subtitle': 'Proyectos reales que entregamos. Identidades reservadas por confidencialidad.',
        ...
        'about.title': 'El nivel de las grandes empresas, sin su complejidad ni su costo.',
        'about.subtitle': 'Ingenieros que automatizan y construyen software dentro de empresas y gobierno — ahora del lado de tu negocio.',
        'about.diff1.title': '+14 años combinados',
        ...
        'proof.m1.label': 'Años de Experiencia Combinada',
        'proof.m2.label': 'Proyectos Entregados',
        'proof.m3.label': 'Días para tu primer MVP',
        ...
        'contact.subtitle': 'Agenda una llamada estratégica gratuita y descubre cómo podemos transformar tus operaciones desde 7-14 días',
    ...
    en: {
        ...
        'portfolio.home.title': 'Cases that back what we do',
        'portfolio.home.subtitle': 'Real projects we delivered. Identities kept confidential.',
        ...
        'about.title': 'Enterprise-grade work, without the complexity or the cost.',
        'about.subtitle': 'Engineers who automate and build software inside enterprise and government — now on your side.',
        'about.diff1.title': '14+ combined years',
        ...
        'proof.m1.label': 'Years of Combined Experience',
        'proof.m2.label': 'Projects Delivered',
        'proof.m3.label': 'Days to your first MVP',
        ...
        'contact.subtitle': 'Book a free strategy call and discover how we can transform your operations from 7-14 days',
