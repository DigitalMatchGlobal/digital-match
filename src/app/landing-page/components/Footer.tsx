    ...
    label: string;
    href: string;
    isExternal?: boolean; // Bandera opcional para saber si es link interno o externo
    }
    ...
    // Enlaces de Servicios (Anclas internas)
    ...
    // Enlaces Legales (Rutas internas a las nuevas páginas)
    ...
    // Función para renderizar links. Si es ruta legal (/...), usa Link. Si es ancla (#...), usa Link normal también.
