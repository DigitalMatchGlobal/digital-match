...
**Ramas listas SIN mergear ni pushear (2026-08-15):**
- `feat/casos-enterprise` — segmento enterprise + 3 casos nuevos (portfolio a 12) con métricas reales.
- `feat/contacto-matchbot` — `ContactSection` sin formulario ni FormSubmit: selector de intención → WhatsApp/MatchBot (ver §2).
- Las dos mergean limpio a `main`, incluso una después de la otra (verificado con merge de prueba).
...
- [ ] **QA móvil en WebKit** de la sección de contacto nueva (ver la regla de arriba). Playwright no está instalado en este repo.
